...
function ReviewGrid() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-violet-100" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-violet-100" />
    </div>
  );
}
...
export default function Testimonial() {
  return (
    <section
      ...
      className="bg-violet-100 rounded"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8  bg-violet-100 pt-20">
        <motion.div
        ...
        >
          ...
          <TypingTitle title="What People Say about us" />
          <SectionHeading />
        </motion.div>
        <ReviewGrid />
      </div>
